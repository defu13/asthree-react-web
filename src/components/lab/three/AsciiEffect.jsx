    ...
    constructor(options = {}) {
        ...
        super("AsciiEffect", fragmentShader, {
            ...
            uniforms: new Map([
                ...
                [
                    "scanlineIntensity",
                    new Uniform(postfx.scanlineIntensity || 0),
                ],
                ...
                [
                    "mouseGlowEnabled",
                    new Uniform(postfx.mouseGlowEnabled || false),
                ],
                ["mouseGlowRadius", new Uniform(postfx.mouseGlowRadius || 200)],
                [
                    "mouseGlowIntensity",
                    new Uniform(postfx.mouseGlowIntensity || 1.5),
                ],
                [
                    "vignetteIntensity",
                    new Uniform(postfx.vignetteIntensity || 0),
                ],
                ...
                [
                    "aberrationStrength",
                    new Uniform(postfx.aberrationStrength || 0),
                ],
