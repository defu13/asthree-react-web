...
const SpecularButton = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`relative m-0 inline-flex cursor-pointer items-center justify-center border-none font-medium outline-none transition-transform duration-150  disabled:cursor-default disabled:opacity-55 disabled:active:scale-100 [border-radius:var(--sb-radius)] focus-visible:outline-2 focus-visible:outline-offset-[3px] ${className ? ` ${className}` : ''}`}
      style={{
        '--sb-radius': `${radius}px`,
        '--sb-tint': tint,
    ...
    >
      ...
      <span className="relative z-[2] flex items-center gap-3">{children}</span>
    </button>
  );
};
